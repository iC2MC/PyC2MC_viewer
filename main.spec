...
a = Analysis(['main.py'],
             ...
             hiddenimports=['sklearn.utils._typedefs',"sklearn.neighbors._quad_tree","sklearn._tree",'sklearn.neighbors._partition_nodes','sklearn.utils._cython_blas',"sklearn.tree._utils",'sklearn.utils._weight_vector','chemparse'],
             hookspath=[],
             hooksconfig={},
             runtime_hooks=[],
             excludes=[],
