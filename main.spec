...
a = Analysis(['main.py'],
             pathex=[],
             binaries=[('C:\\Users\\L1125616\\AppData\\Local\\anaconda3\\envs\\PyC2MC_Viewer\\Library\\bin\\pythoncom39.dll','.')],
             datas=[('src/AtomicWeightsAndIsotopicCompNIST2019.txt','.'),('src/Py2MC_icon.png','.'),('Isotopes.csv','.')],
