...
def plot_fun(
    ...
    if (
        kind == "scatter"
    ):  # Scatter plot for DBE, Van krevelen, Kendricks and ppm vs mz plots.
        plt.scatter(
            x,
            y,
            s=d_size,
        ...
        kind == "histo"
    ):  # Bar diagram for composition, error distribution, DBE distribution (solo and merged),
        plt.bar(
            x,
            y,
            yerr=error_data,
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        def getSettings():
            ...
            self.settingsColormap = QSettings("PyC2MC", "Colormap")
            [
                widgets.list_color_map.setCurrentItem(x)
                for x in widgets.list_color_map.findItems(
                    self.settingsColormap.value("Colormap"), QtCore.Qt.MatchExactly
                )
            ]
        ...
        def saveSettings():
            ...
            self.settingsExit.setValue(
                "ExitConfirm", widgets.btn_confirmClose.isChecked()
            )

            self.settingsMinimize.setValue(
                "Minimize", widgets.btn_minimizeAuto.isChecked()
            )
        ...
        def openCloseViewBox():
            ...
            if (
                self.settingsMinimize.value("Minimize") == "true"
                or sender == "btn_view"
                or sender == "viewCloseColumnBtn"
            ):
        ...
        def openCloseCompareBox():
            ...
            if (
                self.settingsMinimize.value("Minimize") == "true"
                or sender == "btn_compare"
                or sender == "compareCloseColumnBtn"
            ):
        ...
        widgets.btn_settings.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.graph_param)
        )
        ...
        # Overview
        widgets.btn_overview.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.view)
        )
        widgets.btn_overview.clicked.connect(
            lambda: widgets.choose_plot_stacked.setCurrentWidget(widgets.page_overview)
        )
        ...
        # DBE
        widgets.btn_DBE.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.view)
        )
        widgets.btn_DBE.clicked.connect(
            lambda: widgets.choose_plot_stacked.setCurrentWidget(widgets.page_DBE)
        )
        ...
        # VK
        widgets.btn_van_krevelen.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.view)
        )
        widgets.btn_van_krevelen.clicked.connect(
            lambda: widgets.choose_plot_stacked.setCurrentWidget(widgets.page_VK)
        )
        ...
        # Kendrick
        widgets.btn_kendricks.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.view)
        )
        widgets.btn_kendricks.clicked.connect(
            lambda: widgets.choose_plot_stacked.setCurrentWidget(widgets.page_Kendrick)
        )
        ...
        # EV
        widgets.btn_EV.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.view)
        )
        widgets.btn_EV.clicked.connect(
            lambda: widgets.choose_plot_stacked.setCurrentWidget(widgets.page_EV)
        )
        ...
        widgets.radio_composition.clicked.connect(
            lambda: widgets.stackedWidget_overview.setCurrentWidget(
                widgets.page_composition
            )
        )
        # Displays error plots page
        widgets.radio_error_plots.clicked.connect(
            lambda: widgets.stackedWidget_overview.setCurrentWidget(
                widgets.page_error_plots
            )
        )
        # Displays Intensity vs DBE plots page
        widgets.radio_distributions.clicked.connect(
            lambda: widgets.stackedWidget_overview.setCurrentWidget(
                widgets.page_intens_vs_DBE
            )
        )
        # Displays spectrum page
        widgets.radio_mass_spectrum.clicked.connect(
            lambda: widgets.stackedWidget_overview.setCurrentWidget(
                widgets.page_mass_spectrum
            )
        )
        ...
        # /////////////////////////////////
        widgets.buttonKendrickStd.clicked.connect(
            lambda: widgets.stackedWidget_Kendrick.setCurrentWidget(widgets.page_std)
        )
        widgets.buttonKendrickExt.clicked.connect(
            lambda: widgets.stackedWidget_Kendrick.setCurrentWidget(widgets.page_ext)
        )
        widgets.buttonKendrickUniv.clicked.connect(
            lambda: widgets.stackedWidget_Kendrick.setCurrentWidget(widgets.page_univ)
        )
        ...
        widgets.radio_ACOS.clicked.connect(
            lambda: widgets.stackedWidget_EV.setCurrentWidget(widgets.page_ACOS)
        )
        widgets.radio_MAI.clicked.connect(
            lambda: widgets.stackedWidget_EV.setCurrentWidget(widgets.page_MAI)
        )
        widgets.radio_MCR.clicked.connect(
            lambda: widgets.stackedWidget_EV.setCurrentWidget(widgets.page_MCR)
        )
        ...
        # Overview
        widgets.btn_overview_compare.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.compare)
        )
        widgets.btn_overview_compare.clicked.connect(
            lambda: widgets.Compare_stacked_widget.setCurrentWidget(
                widgets.page_compare_overview
            )
        )
        ...
        # FC maps
        widgets.btn_molecular_cartographies.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.compare)
        )
        widgets.btn_molecular_cartographies.clicked.connect(
            lambda: widgets.Compare_stacked_widget.setCurrentWidget(
                widgets.page_molecular_cartographies
            )
        )
        ...
        widgets.btn_molecular_cartographies.clicked.connect(
            lambda: self.colorTab("Compare")
        )

        # DBE maps
        widgets.btn_DBE_compare_menu.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.compare)
        )
        widgets.btn_DBE_compare_menu.clicked.connect(
            lambda: widgets.Compare_stacked_widget.setCurrentWidget(
                widgets.page_compare_DBE
            )
        )
        ...
        # VK plot
        widgets.btn_VK_compare_menu.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.compare)
        )
        widgets.btn_VK_compare_menu.clicked.connect(
            lambda: widgets.Compare_stacked_widget.setCurrentWidget(
                widgets.page_compare_VK
            )
        )
        ...
        # KMD plot
        widgets.btn_KMD_compare_menu.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.compare)
        )
        widgets.btn_KMD_compare_menu.clicked.connect(
            lambda: widgets.Compare_stacked_widget.setCurrentWidget(
                widgets.page_compare_KMD
            )
        )
        ...
        # EV plot
        widgets.btn_EV_compare_menu.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.compare)
        )
        widgets.btn_EV_compare_menu.clicked.connect(
            lambda: widgets.Compare_stacked_widget.setCurrentWidget(
                widgets.page_compare_EV
            )
        )
        ...
        widgets.radio_mass_spectrum_compare.clicked.connect(
            lambda: widgets.stackedWidget_overview_compare.setCurrentWidget(
                widgets.page_mass_spectrum_compare
            )
        )
        # Displays distribution widget
        widgets.radio_distribution_compare.clicked.connect(
            lambda: widgets.stackedWidget_overview_compare.setCurrentWidget(
                widgets.page_distribution_compare
            )
        )
        # Displays Composition widget
        widgets.radio_composition_compare.clicked.connect(
            lambda: widgets.stackedWidget_overview_compare.setCurrentWidget(
                widgets.page_composition_compare
            )
        )
        ...
        # Displays DBE widget
        widgets.btn_DBE_compare.clicked.connect(
            lambda: widgets.stackedWidget_FC.setCurrentWidget(widgets.page_DBE_compare)
        )
        # Displays Van Krevelen widget
        widgets.btn_VK_compare.clicked.connect(
            lambda: widgets.stackedWidget_FC.setCurrentWidget(widgets.page_VK_compare)
        )
        # Displays KMD widget
        widgets.btn_KMD_compare.clicked.connect(
            lambda: widgets.stackedWidget_FC.setCurrentWidget(widgets.page_KMD_compare)
        )
        # Displays MD widget
        widgets.btn_MD_compare.clicked.connect(
            lambda: widgets.stackedWidget_FC.setCurrentWidget(widgets.page_MD_compare)
        )

        # /////////////////////////////////
        #   COMPARE\KENDRICK BUTTONS CONNECTIONS
        # /////////////////////////////////
        widgets.buttonKendrickStd_comp.clicked.connect(
            lambda: widgets.stackedWidget_Kendrick_comp.setCurrentWidget(
                widgets.page_std_comp
            )
        )
        widgets.buttonKendrickUniv_comp.clicked.connect(
            lambda: widgets.stackedWidget_Kendrick_comp.setCurrentWidget(
                widgets.page_univ_2
            )
        )
        ...
        widgets.radio_ACOS_comp.clicked.connect(
            lambda: widgets.stackedWidget_EV_comp.setCurrentWidget(
                widgets.page_ACOS_comp
            )
        )
        widgets.radio_MAI_comp.clicked.connect(
            lambda: widgets.stackedWidget_EV_comp.setCurrentWidget(
                widgets.page_MAI_comp
            )
        )
        widgets.radio_MCR_comp.clicked.connect(
            lambda: widgets.stackedWidget_EV_comp.setCurrentWidget(
                widgets.page_MCR_comp
            )
        )
        ...
        # Displays venn page
        widgets.btn_venn.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.stats)
        )
        widgets.btn_venn.clicked.connect(
            lambda: widgets.stats_stacked_widget.setCurrentWidget(widgets.page_venn)
        )
        ...
        # Displays PCA page
        widgets.btn_PCA.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.stats)
        )
        widgets.btn_PCA.clicked.connect(
            lambda: widgets.stats_stacked_widget.setCurrentWidget(widgets.page_PCA)
        )
        ...
        # Displays HCA page
        widgets.btn_HCA.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.stats)
        )
        widgets.btn_HCA.clicked.connect(
            lambda: widgets.stats_stacked_widget.setCurrentWidget(widgets.page_HCA)
        )
        ...
        widgets.btn_Volcano.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.stats)
        )
        widgets.btn_Volcano.clicked.connect(
            lambda: widgets.stats_stacked_widget.setCurrentWidget(widgets.page_Volcano)
        )
        ...
        widgets.btn_pl_comp.clicked.connect(
            lambda: widgets.stackedWidget.setCurrentWidget(widgets.stats)
        )
        widgets.btn_pl_comp.clicked.connect(
            lambda: widgets.stats_stacked_widget.setCurrentWidget(widgets.page_pl_comp)
        )
        ...
        # Displays KMD widget
        widgets.btn_KMD_stats.clicked.connect(
            lambda: widgets.stackedWidget_FC_stats.setCurrentWidget(
                widgets.page_KMD_compare_2
            )
        )
        # Displays MD widget
        widgets.btn_MD_stats.clicked.connect(
            lambda: widgets.stackedWidget_FC_stats.setCurrentWidget(
                widgets.page_MD_compare_2
            )
        )
        ...
        widgets.list_loaded_file_2.itemSelectionChanged.connect(
            self.split_classes_merged
        )
        widgets.list_distribution.itemSelectionChanged.connect(self.distrib_pannel)
        widgets.list_distribution_compare.itemSelectionChanged.connect(
            self.distribution_compare_pannel
        )
        widgets.list_loaded_file_compare.itemSelectionChanged.connect(
            self.compare_calculation
        )
        widgets.list_loaded_file_compare.setSelectionMode(
            QtWidgets.QAbstractItemView.ExtendedSelection
        )
        widgets.list_classes_distrib.setSelectionMode(
            QtWidgets.QAbstractItemView.ExtendedSelection
        )
        widgets.list_compare_sample_1.setSelectionMode(
            QtWidgets.QAbstractItemView.SingleSelection
        )
        widgets.list_compare_sample_2.setSelectionMode(
            QtWidgets.QAbstractItemView.SingleSelection
        )
        widgets.list_sample_1_stats.setSelectionMode(
            QtWidgets.QAbstractItemView.SingleSelection
        )
        widgets.list_sample_2_stats.setSelectionMode(
            QtWidgets.QAbstractItemView.SingleSelection
        )
        ...
        widgets.mz_extraction.clicked.connect(self.KMD_ext_label_update)
        widgets.KMD_Extraction.clicked.connect(self.KMD_ext_label_update)
        ...
        ##FC maps
        ### KMD
        widgets.edit_motif_compare.textChanged.connect(
            self.kendrick_motif_compare_calculation
        )
        ...
        # KMD
        widgets.edit_motif_stats.textChanged.connect(
            self.kendrick_motif_stats_calculation
        )
    ...
    def write_csv_df(self, path, filename, df):
        ...
        if not files_present:
            ...
            overwrite = QMessageBox.question(
                self, "Message", overwrite_msg, QMessageBox.Yes, QMessageBox.No
            )
            if overwrite == QMessageBox.Yes:
                try:
                    ...
                    reply = QMessageBox.information(
                        self, "Message", msg, QMessageBox.Ok, QMessageBox.Ok
                    )
                    return
            elif overwrite == QMessageBox.No:
                new_filename, okPressed = QInputDialog.getText(
                    self, "Save Name", "Name of the merged file: ", QLineEdit.Normal, ""
                )
    ...
    def about(self, last_modified):
        ...
        msg = (
            "PyC2MC Viewer: a FTMS data visualization software. <br><br>\
            ...
            GUI based on PyDracula by Wanderson M. Pimenta."
            % (link_git, link_preprint, self.last_modified)
        )
        reply = QMessageBox.information(
            self, "Message", msg, QMessageBox.Ok, QMessageBox.Ok
        )

    # RECOLOR/UI UPDATE EVENTS
    # ///////////////////////////////////////////////////////////////
    def colorTab(self, tab):
        ...
        if tab == "View":
            widgets.btn_view.setStyleSheet(
                self.bak_view
                + "QPushButton {border-right: 1.5px solid rgb(208,208,208);border-bottom: 1.5px solid rgb(208,208,208)}"
            )
        elif tab == "Compare":
            widgets.btn_compare.setStyleSheet(
                self.bak_comp
                + "QPushButton {border-right: 1.5px solid rgb(208,208,208);border-bottom: 1.5px solid rgb(208,208,208)}"
            )
        elif tab == "Stats":
    ...
    def buttonColor(self):
        ...
        if btn.objectName() == "btn_settings":  # Exception to keep the icon
            ...
            btn.setStyleSheet(
                "QPushButton {background-color:  rgb(208,208,208);\n"
                + self.style_backup
                + "}"
            )
        self.btn_bak = btn

    def KMD_ext_label_update(self):
        if widgets.mz_extraction.isChecked() == True:
            widgets.label_3.setText("m/z")
        else:
            widgets.label_3.setText("KMD")
    ...
    def load_file_method(self):
        ...
        widgets.pbar.show()
        type_color = {
            "PyC2MC_fusion": "#dd324d",
            "Peaklist": "#2d6bad",
            "Attributed": "#f0a23e",
            "PyC2MC_merged": "#42d66a",
            "PyC2MC_merged_unattributed": "#bfb0b7",
        }
        p = 0
        # Get the filepath
        filepath, _ = QtWidgets.QFileDialog.getOpenFileNames(
            caption="Choose one result file or more to import",
            filter="Results files (*.csv;*.asc;*.xlsx;*.xls)",
        )
        if not filepath:
            widgets.pbar.hide()
            return
        ...
        while n < len(filepath):
            ...
            try:
                ...
                QMessageBox.about(
                    self,
                    "FYI box",
                    f"A problem has occured with the following file: '{filename}', error is : {err}",
                )
                n = n + 1
                if n < len(filepath):
                    p = (n + 1) / len(filepath) * 100
            ...
            if dataframe.df_type == "Error":
                QMessageBox.about(
                    self,
                    "FYI box",
                    f".xlsx files should only come from CERES processing, '{filename}' isn't such a file",
                )
            ...
            if dataframe.df_type == "PyC2MC_merged":
                if (
                    "std_dev_rel" in dataframe.df
                ):  # Fused replicates file (specific merging type)
    ...
    def merge_files(self):
        ...
        if len(names) == 1:
            QMessageBox.about(
                self,
                "FYI box",
                "Only one file was selected ! Please, select several files.",
            )
            widgets.pbar.hide()
            return
        save_name, okPressed = QInputDialog.getText(
            self, "Save Name", "Your name:", QLineEdit.Normal, ""
        )
    ...
    def fusion_replicats(self):
        ...
        widgets.pbar.show()
        try:
            names = QtWidgets.QFileDialog.getOpenFileNames(
                filter="Results files (*.csv;*.asc;*.xls;*.xlsx)"
            )
            path_old = os.getcwd()
            ...
            return
        try:
            replicats_tuple = QInputDialog.getInt(
                self,
                "Extraction of species common to x replicates",
                "Species must be found in at least x samples : ",
                min=1,
                max=len(names[0]),
            )
        except:
        ...
        save_name, okPressed = QInputDialog.getText(
            self, "Filename and save name", "Your name:", QLineEdit.Normal, ""
        )
        i = 50
    ...
    def merge_merged_files(self):
        ...
        if okPressed and save_name != "":
            try:
                ...
                widgets.pbar.hide()
                QMessageBox.about(
                    self, "FYI box", "You can only merge the same type of file"
                )
                return
        # os.chdir(path_to_file)
        # self.merged_data.to_csv(save_name +".csv",index = False)
    ...
    def merge_Multicsv(
        self,
    ):  # Merged files from sequential attribution (Obritrap only) (To update ?)
    ...
    def merge_unattributed_files(self):
        ...
        try:
            ...
            min_rel_int, ok = QInputDialog.getDouble(
                self,
                "Choose Minimum Rel. Int. value",
                "Do you want to set a lower limit for the relative intensity ? \nCancel if you don't.",
                value=0.1,
                min=0,
                max=50,
                decimals=3,
        ...
        if okPressed and save_name != "":
            try:
                self.merged_data = merge_non_attributed(
                    names,
                    tol,
                    min_rel_intens=min_rel_int,
                    callback=widgets.pbar.setValue,
                )
            except:
                widgets.pbar.hide()
                QMessageBox.about(self, "FYI box", "Impossible to merge selected files")
        ...
        try:
            ...
            widgets.pbar.hide()
            QMessageBox.about(
                self, "FYI box", "An error occurs during the saving of your file"
            )
            return
    ...
    def split_classes(self):
        ...
        while n < len(self.data.classes):
            item_classes = QtWidgets.QListWidgetItem(
                self.data.classes_concat.iloc[n, 0]
            )
            ...
            if data_selected.df_type == "Attributed":
                ...
                for classe in classes.variable:
                    temp = Select_classe(
                        classe,
                        data_selected.df,
                        data_selected.heteroatoms,
                        data_selected.classes,
                    )
                    mean_DBE = weighted_average_m1(
                        temp["DBE"], temp["normalized_intensity"]
                    )
    ...
    def overview(self, gif=False):
        ...
        if widgets.radio_composition.isChecked():
            ...
            for item_class in item_classes:
                ...
                if "count" in data_selected.df:
                    ...
                    if widgets.edit_min_intensity_classes.text():
                        min_intens_classes = float(
                            widgets.edit_min_intensity_classes.text()
                        )
                        if widgets.radio_classes.isChecked():
                            ...
                            if "CH" in data_selected.classes["variable"].values:
                                data = data.append(
                                    data_selected.classes[
                                        data_selected.classes["variable"].str.contains(
                                            "CH"
                                        )
                                    ]
                                )
                    ...
                    data = data.sort_values("value", ascending=False).reset_index(
                        drop=True
                    )
                    if widgets.radio_comp_int.isChecked():
                        ...
                        mplcursors.cursor(multiple=True).connect(
                            ...
                            lambda sel: sel.annotation.set_text(
                                f"{data['variable'].iloc[sel.target.index]}: Rel. Intensity  = {round(data['value'].iloc[sel.target.index],2)}%, std deviation = {round(data['std_dev_rel'].iloc[sel.target.index],2)}%"
                            ),
                        )
                        ...
                        mplcursors.cursor(multiple=True).connect(
                            "add",
                            lambda sel: sel.annotation.set_text(
                                f"{data['variable'].iloc[sel.target.index]}: Count  = {int(data['number'].iloc[sel.target.index])}"
                            ),
                        )
                else:
                    if widgets.radio_classes.isChecked():
                    ...
                    if widgets.edit_min_intensity_classes.text():
                        ...
                        if not widgets.radio_classes.isChecked():
                            ...
                            data = data_temp.append(
                                data[data["variable"].str.contains("CH")]
                            )
                    ...
                    if widgets.radio_comp_int.isChecked():
                        ...
                        mplcursors.cursor(multiple=True).connect(
                            "add",
                            lambda sel: sel.annotation.set_text(
                                f"{data['variable'].iloc[sel.target.index]}: Rel. Intensity  = {round(data['value'].iloc[sel.target.index],2)}%"
                            ),
                        )
                    elif widgets.radio_comp_nb.isChecked():
                        data["number"] = (
                            data["number"].div(data["number"].sum(axis=0)) * 100
                        )
                        data = data.sort_values("number", ascending=False).reset_index(
                            drop=True
                        )
                        ax.bar(data["variable"], data["number"])
                        y_label = "Number of attribution (%)"
                        mplcursors.cursor(multiple=True).connect(
                            "add",
                            lambda sel: sel.annotation.set_text(
                                f"{data['variable'].iloc[sel.target.index]}: Nb. Attrib.  = {int(data['number'].iloc[sel.target.index])}%"
                            ),
                        )
            ...
            mngr.window.setGeometry(
                self.pos().x() + 940, self.pos().y() + 200, 640, 545
            )
        ...
        ##############
            ...
            for item in item_classes:
                ...
                if (
                    widgets.radioButton_norm_d.isChecked()
                    or widgets.radioButton_norm_c.isChecked()
                ):
                    data_extract["Normalized_intensity"], error = Normalize(
                        data_extract["Normalized_intensity"]
                    )
                    if error == 1:
                        QMessageBox.about(
                            self,
                            "Error",
                            f"No species to be displayed for the class : {classe_selected}.",
                        )
                        continue
                ...
                data_extract = data_extract.sort_values(
                    by=["Normalized_intensity"], ascending=True
                )
                ...
                def Anim(frames):
                    ...
                    if widgets.radio_ppm.isChecked():
                        ...
                        cbar.set_label(
                            ...
                            labelpad=-2.625 * (font_size),
                            rotation=90,
                            fontsize=font_size,
                            color=self.cm_text_color,
                        )
                        ...
                        if "m/z" in frames:
                            mplcursors.cursor(multiple=True).connect(
                                "add",
                                lambda sel: sel.annotation.set_text(
                                    frames["molecular_formula"].iloc[sel.target.index]
                                ),
                            )
                    ...
                    ### bar plot  ###
                        ...
                        n_bin = 50
                        error_range = (
                            max(frames["err_ppm"]) + abs(min(frames["err_ppm"]))
                        ) / (
                            n_bin + 1
                        )  # Calculates error range and divides it into 50 sections
                        if widgets.radio_histo.isChecked():
                            Data = frames.groupby(
                                pandas.cut(
                                    frames["err_ppm"],
                                    np.arange(min_error, max_error, error_range),
                                )
                            ).sum()
                        ...
                        for i in range(len(Data["err_ppm"])):
                            lst_error.append(
                                min_error + (error_range / 2) + i * error_range
                            )
                        # Mean error list
                        ...
                        mplcursors.cursor(multiple=True).connect(
                            ...
                            lambda sel: sel.annotation.set_text(
                                "Intensity = "
                                + str(format(df["col2"].iloc[sel.target.index], ".1E"))
                            ),
                        )
            ...
            if gif == False:
                ...
                anim_created = FuncAnimation(
                    Figure, Anim, frames, interval=1000 / self.fps
                )
                mngr = plt.get_current_fig_manager()
                mngr.window.setGeometry(
                    self.pos().x() + 940, self.pos().y() + 200, 640, 545
        ...
        ##############
            ...
            if data_selected.df_type == "Peaklist":
                ...
                plt.stem(
                    data_filtered["m/z"],
                    data_filtered["absolute_intensity"],
                    linefmt="black",
                    markerfmt=" ",
                    basefmt="k",
                )
            ...
            mngr = plt.get_current_fig_manager()
            mngr.window.setGeometry(
                self.pos().x() + 640, self.pos().y() + 200, 640, 545
            )
            plt.show()
                ...
                def Anim(frames, data_selected):
                    ...
                    if x_axes == 0:  # DBE
                        ...
                        while m <= max(frames.DBE):
                            ...
                            intensity_DBE = (
                                sum(data_DBE["Normalized_intensity"])
                                * 100
                                / sum(data_selected.df["Normalized_intensity"])
                            )
                        ...
                        while m <= max(frames.C):
                            ...
                            intensity_C = (
                                sum(data_C["Normalized_intensity"])
                                * 100
                                / sum(data_selected.df["Normalized_intensity"])
                            )
                            number_C = len(data_C)
                        ...
                        while m <= max(frames.N):
                            ...
                            intensity_N = (
                                sum(data_N["Normalized_intensity"])
                                * 100
                                / sum(data_selected.df["Normalized_intensity"])
                            )
                            number_N = len(data_N)
                        ...
                        while m <= max(frames.O):
                            ...
                            intensity_O = (
                                sum(data_O["Normalized_intensity"])
                                * 100
                                / sum(data_selected.df["Normalized_intensity"])
                            )
                            number_O = len(data_O)
                        ...
                        while m <= max(frames.S):
                            ...
                            intensity_S = (
                                sum(data_S["Normalized_intensity"])
                                * 100
                                / sum(data_selected.df["Normalized_intensity"])
                            )
                            number_S = len(data_S)
                    ...
                    def on_add(sel):
                        x, y, width, height = (
                            sel.artist[sel.target.index].get_bbox().bounds
                        )
                        if widgets.radio_dist_nb.isChecked():
                            txt = "Nb. Attrib."
                        else:
                            txt = "Rel. Intens."
                        sel.annotation.set(
                            text=f"DBE: {x+width/2,0}; {txt}: {round(height,4)}%",
                            position=(0, 20),
    ...
    def plot_DBE(self, gif=False):
        ...
        for item in item_classes:
            ...
            data_extract = Select_classe(
                classe_selected, data, data_selected.heteroatoms, data_selected.classes
            )
            # -----------------------------#
            ...
            if widgets.check_log.isChecked():
                Intens = np.log10(
                    Intens + 1e-10
                )  # Avoid having a null value log(0)=error math
            min_max_scaler = preprocessing.MinMaxScaler()
            Intens_scaled = min_max_scaler.fit_transform(Intens)
            ...
            if widgets.radio_even_DBE.isChecked():
                data_extract = data_extract.loc[
                    np.where(data_extract["DBE"].apply(lambda x: x.is_integer()), 0, 1)
                    == 1
                ]
                dbe_text = "Even ions"
            ...
            def Anim(frames):
                ...
                plot_fun(
                    ...
                    x=frames["C"],
                    y=frames["DBE"],
                    d_color=frames["third_dimension"],
                    size=dot_size * frames["Normalized_intensity"],
                    dot_type=self.dot_type,
                    edge=self.edge,
                    cmap=self.color_map,
                )
                ...
                if widgets.radio_color_pc1.isChecked():
                    plt.clim(
                        np.min(data_selected.df["PC1"]), np.max(data_selected.df["PC1"])
                    )
                elif widgets.radio_color_pc2.isChecked():
                    plt.clim(
                        np.min(data_selected.df["PC2"]), np.max(data_selected.df["PC2"])
                    )
                ...
                if "m/z" in frames:
                    mplcursors.cursor(multiple=True).connect(
                        ...
                        lambda sel: sel.annotation.set_text(
                            frames["molecular_formula"].iloc[sel.target.index]
                            + ", #C = "
                            + str(frames["C"].iloc[sel.target.index])
                            + ", DBE = "
                            + str(frames["DBE"].iloc[sel.target.index])
                        ),
                    )
    ...
    def plot_VK(self, gif=False):
        ...
        for item in item_classes:
                ...
                if i < len(element_list):
                    if element_list[i] not in data_filtered.columns:
                        QMessageBox.about(
                            self,
                            "Error",
                            f"No {element_list[i][0]} in the selected data, (H/C)=f[(H/C)] will be plotted instead to avoid crash.",
                        )
                        x_axes, y_axes = 3, 0
            ...
            (
                ...
                x_label,
                y_label,
            ) = Select_Axes_VK(x_axes, y_axes, data_filtered)
            ...
            def Anim(frames):
                ...
                if (
                    widgets.checkBox_vk_area.isChecked()
                    and widgets.list_VK_x.currentRow() == 0
                    and widgets.list_VK_y.currentRow() == 0
                ):
                    border_width = 4
                    alpha = 1
                    patches = [
                        ...
                        },
                        {
                            ...
                            "height": 1.19,
                            "color": "red",
                            "label": "Unsaturated Hydrocarbons",
                        },
                        {
                            "left": 0.31,
                            "bottom": 1.52,
                    ...
                    patches_labels = [
                        mpatches.Patch(color=patch["color"], label=patch["label"])
                        for patch in patches
                    ]
    ...
    def plot_PCA(self):
        ...
        n_ech = n_ech - 2
        if (
            int(widgets.lineEdit_n_component.text()) > n_ech
            or int(widgets.lineEdit_n_component.text()) < 3
        ):
            QMessageBox.about(
                self,
                "FYI box",
                "Number of component must be comprised between 3 and the number of compared samples, i.e. "
                + str(n_ech)
                + " in this case.",
            )
            return
        ...
        score_coef, first_comps = plot_pca(
            pca_data, axes, n_comp, pca_on, para_dict=self.para_dict
        )
        data_selected.df.columns = data_old
        mngr = plt.get_current_fig_manager()
        mngr.window.setGeometry(self.pos().x() + 640, self.pos().y() + 200, 640, 545)
        self.data_with_coef = pandas.merge(
            left=data_selected.df, right=score_coef, left_on="m/z", right_on="m/z"
        )
    ...
    def volcano(self):
        ...
        if widgets.cb_significancy_volc.isChecked():
            ...
            pmin = 100
        if (
            widgets.cb_005.isChecked() == False
            and widgets.cb_001.isChecked() == False
            and widgets.cb_0001.isChecked() == False
        ):
            pmin = 100
        ...
        if not widgets.cb_volc_color.isChecked():
            ...
            volc_data = pandas.concat([grey_data_fc, volc_data]).drop_duplicates(
                keep=False
            )

            grey_data_p = volc_data.drop(
                volc_data[volc_data["p"] > -np.log10(pmin)].index
            )
            volc_data = pandas.concat([grey_data_p, volc_data]).drop_duplicates(
                keep=False
            )
        ...
        if widgets.volc_color_classes.isChecked():
            ...
            for fam in volc_data["family_name"].drop_duplicates():
                ...
                scatter = plt.scatter(
                    ...
                    to_plot["p"],
                    s=dot_size * 0.75,
                    c=to_plot["family_color"].astype(str),
                    label=fam,
                    edgecolor="black",
                    linewidths=0.75,
                    alpha=0.8,
            ...
            scatter = plot_fun(
                ...
                volc_data["fc"],
                volc_data["p"],
                d_color=volc_data["DBE"],
                cmap=self.color_map,
            )
            cbar = plt.colorbar()
            cbar.set_label(
                "DBE",
                labelpad=-2.4 * (font_size),
                rotation=90,
                fontsize=font_size,
                color=self.cm_text_color,
            )
            ...
            scatter = plot_fun(
                ...
                volc_data["fc"],
                volc_data["p"],
                d_color=volc_data["O/C"],
                cmap=self.color_map,
            )
            cbar = plt.colorbar()
            cbar.set_label(
                "O/C",
                labelpad=-3.15 * (font_size),
                rotation=90,
                fontsize=font_size,
                color=self.cm_text_color,
            )
        ...
        try:
            ...
            mplcursors.cursor(multiple=True).connect(
                "add",
                lambda sel: sel.annotation.set_text(
                    volc_data["sum_formula"].iloc[sel.target.index]
                ),
            )
        except:
            try:
                mplcursors.cursor(multiple=True).connect(
                    "add",
                    lambda sel: sel.annotation.set_text(
                        volc_data["m/z"].iloc[sel.target.index]
                    ),
                )
            except:
                return
    ...
    def pl_comp_KMD(self, gif=False):
        ...
        data_selected.df["Kendrick mass"] = data_selected.df["m/z"] * (
            nominal_unit / repetive_unit_mass
        )
        data_selected.df["Kendrick nominal mass"] = round(data_selected.df["m/z"])

        if widgets.round_up_stats.isChecked():
            data_selected.df["Kendrick nominal mass"] = data_selected.df[
                "Kendrick mass"
            ].apply(np.ceil)
        elif widgets.round_closest_stats.isChecked():
            data_selected.df["Kendrick nominal mass"] = round(
                data_selected.df["Kendrick mass"]
            )
        data_selected.df["Kendrick mass defect"] = (
            data_selected.df["Kendrick nominal mass"]
            - data_selected.df["Kendrick mass"]
        )
        ...
        data_extract = data_selected.df.drop(
        ...
        data_extract = data_extract.sort_values(
            by=["fc", "summed_intensity"], ascending=[False, True]
        )
        ...
        def Anim(frames):
            ...
            if widgets.CheckBox_size_fc_kmd_stats.isChecked():
                size = self.d_size * frames.data_extract.iloc[
                    :,
                    data_selected.df.columns.get_loc("summed_intensity")
                    - (n_sample)
                    + sample_1,
                ].astype(float)
                size_inf_neg = self.d_size * frames.data_inf_neg.iloc[
                    :,
                    data_selected.df.columns.get_loc("summed_intensity")
                    - (n_sample)
                    + sample_1,
                ].astype(float)
                size_inf_pos = self.d_size * frames.data_inf_pos.iloc[
                    :,
                    data_selected.df.columns.get_loc("summed_intensity")
                    - (n_sample)
                    + sample_2,
            ...
            if widgets.fc_all_kmd_stats.isChecked():
                plot_fun(
                    "scatter",
                    x=frames.data_inf_neg["Kendrick nominal mass"],
                    y=frames.data_inf_neg["Kendrick mass defect"],
                    d_color="#a84ca4",
                    dot_type=self.dot_type,
                    edge=self.edge,
                    size=size_inf_neg,
                ...
                plot_fun(
                    "scatter",
                    x=frames.data_inf_pos["Kendrick nominal mass"],
                    y=frames.data_inf_pos["Kendrick mass defect"],
                    d_color="#0070c0",
                    dot_type=self.dot_type,
                    edge=self.edge,
                    size=size_inf_pos,
            ...
            plt.scatter(
                frames.data_extract["Kendrick nominal mass"],
                frames.data_extract["Kendrick mass defect"],
                s=size,
                c=frames.data_extract["fc"],
                vmin=-8,
                vmax=8,
                cmap="RdYlGn",
                edgecolor="black",
            ...
            if len(data.data_extract) != 0:
                ...
                cbar.set_label(
                    "log2(FC)", labelpad=-2.625 * (font_size), rotation=90, fontsize=16
                )
            ...
            if widgets.fc_all_kmd_stats.isChecked():
                legend_elements = [
                    Patch(
                        facecolor="#a84ca4", edgecolor="k", label=leg_1 + " exclusive"
                    ),
                    Patch(
                        facecolor="#0070c0", edgecolor="k", label=leg_2 + " exclusive"
                    ),
                ]
                plt.legend(handles=legend_elements, fontsize=font_size - 4)
            if gif == False:
                mngr = plt.get_current_fig_manager()
                mngr.window.setGeometry(
                    self.pos().x() + 940, self.pos().y() + 200, 800, 680
                )
            if "m/z" in frames.data_extract:
                mplcursors.cursor(multiple=True).connect(
                    ...
                    lambda sel: sel.annotation.set_text(
                        "m/z = "
                        + str(frames.data_extract["m/z"].iloc[sel.target.index])
                    ),
                )
    ...
    def kendrick_motif_compare_calculation(self):
        ...
        widgets.edit_mass_motif_compare.setText(
            str(mass)
        )  # Modify text in "mass_motif"
    ...
    def plot_Kendrick(self, gif=False):
        ...
        if data_selected.df_type == "PyC2MC_merged":
            data_filtered = data_filtered.rename(
                columns={"summed_intensity": "normalized_intensity"}
            )
        data_filtered = data_filtered.sort_values(
            by=["normalized_intensity"], ascending=True
        )
        ...
        if widgets.stackedWidget_Kendrick.currentIndex() == 1:
            ...
            if widgets.set_intensity_KMD.text():
                ...
                data_filtered = data_filtered[
                    data_filtered.normalized_intensity >= intens_KMD
                ]

            if "mz" in data_filtered:
                data_filtered["Kendrick mass"] = data_filtered["mz"] * (
                    nominal_unit / repetive_unit_mass
                )
            elif "count" in data_filtered:
                data_filtered["Kendrick mass"] = data_filtered["m/z"] * (
                    nominal_unit / repetive_unit_mass
                )
            ...
            if widgets.roundUp.isChecked():
                data_filtered["Kendrick nominal mass"] = data_filtered[
                    "Kendrick mass"
                ].apply(np.ceil)
            elif widgets.roundClosest.isChecked():
                data_filtered["Kendrick nominal mass"] = round(
                    data_filtered["Kendrick mass"]
                )

            data_filtered["Kendrick mass defect"] = (
                data_filtered["Kendrick nominal mass"] - data_filtered["Kendrick mass"]
            )
            ...
            list_series_index = []
            list_color = [
                widgets.comboBox_1.currentText(),
                widgets.comboBox_2.currentText(),
                widgets.comboBox_3.currentText(),
                widgets.comboBox_4.currentText(),
                widgets.comboBox_5.currentText(),
                widgets.comboBox_6.currentText(),
            ...
            for j in list_series_index:
                ...
                if widgets.mz_extraction.isChecked():
                    try:
                        ...
                        QMessageBox.about(
                            self,
                            "FYI box",
                            "Only use digits and dots for m/z or KMD values (no comma !)",
                        )
                        return
                ...
                try:
                    ...
                    QMessageBox.about(
                        self,
                        "FYI box",
                        "Only use digits and dots for m/z values (no comma !)",
                    )
                    return
                ...
                if widgets.KMD_Extraction.isChecked():
                    try:
                        kmd = float(list_series[j].text())
                    except:
                        QMessageBox.about(
                            self,
                            "FYI box",
                            "Only use digits and dots for KMD values (no comma !)",
                        )
                        return
            ...
            d = {
                "col1": data_filtered["Kendrick nominal mass"],
                "col2": data_filtered["Kendrick mass defect"],
                "normalized_intensity": data_filtered["normalized_intensity"],
                "id": data_filtered["id"],
                "m/z": data_filtered["m/z"],
            }
            df = pandas.DataFrame(data=d)
            ...
            if widgets.checkBox_extract_only.isChecked() == False:
                plt.scatter(
                    ...
                    df["col2"],
                    color=[0, 0, 0, 0.1],
                    s=df["normalized_intensity"] * dot_size / 100,
                )
            for k in list_series_index:
                d_series = data_filtered[data_filtered["id"] == k + 1]
                plt.scatter(
                    d_series["Kendrick nominal mass"],
                    d_series["Kendrick mass defect"],
                    color=list_color[k],
                    s=(d_series["normalized_intensity"]) * dot_size / 100,
                    edgecolors="black",
                )
            ...
            mplcursors.cursor(multiple=True).connect(
                "add",
                lambda sel: sel.annotation.set_text(
                    d_series["m/z"].iloc[sel.target.index]
                ),
            )
            mngr = plt.get_current_fig_manager()
            mngr.window.setGeometry(
            ...
            for item in item_classes:
                ...
                if item == "Unatributed":
                    ...
                    if classe_selected == "All":
                        ...
                        classes_index = data_selected.classes[
                            data_selected.classes["variable"] == classe_selected
                        ]
                        index_classes = (
                            data_filtered[data_selected.heteroatoms.columns]
                            == data_selected.heteroatoms.iloc[classes_index.index[0]]
                        ).all(1)
                        data_filtered = data_filtered[index_classes]
                ...
                data_filtered["Kendrick mass defect"] = (
                    data_filtered["Kendrick nominal mass"]
                    - data_filtered["Kendrick mass"]
                )
                if data_selected.df_type == "PyC2MC_merged":
                    data_filtered = data_filtered.rename(
                ...
                if widgets.log_intens_K.isChecked():
                    Intens = np.log10(
                        data_filtered["normalized_intensity"].copy() + 1e-10
                    )
                ...
                # -----------------------------------#
                if widgets.radioButton_norm_d.isChecked():
                    data_filtered["normalized_intensity"], error = Normalize(
                        data_filtered["normalized_intensity"]
                    )
                    if error == 1:
                        QMessageBox.about(
                            self,
                ...
                def Anim(frames):
                    ...
                    if (
                        widgets.stackedWidget_Kendrick.currentIndex() == 0
                    ):  # KMD classic
                        ...
                        widgets.stackedWidget_Kendrick.currentIndex() == 2
                    ):  # Mass defect VS Nominal mass
                        x_data = "nominal_mass"
                        y_data = "mass_defect"
                    ...
                    plot_fun(
                        ...
                        y=frames[y_data],
                        d_color=frames["third_dimension"],
                        size=1.5 * dot_size * frames["normalized_intensity"],
                        dot_type=self.dot_type,
                        edge=self.edge,
                        cmap=self.color_map,
                    )
                    ...
                    if "molecular_formula" in frames:
                        ...
                        mplcursors.cursor(multiple=True).connect(
                            "add",
                            lambda sel: sel.annotation.set_text(
                                frames["m/z"].iloc[sel.target.index]
                            ),
                        )
                    plt.xticks(fontsize=font_size)
                    plt.yticks(fontsize=font_size)
    ...
    def deformulation(self, gif=False):
        ...
        filepath, _ = QtWidgets.QFileDialog.getOpenFileName(
            caption="Choose the file containing the info about the species to identify",
            filter="Results files (*.csv)",
        )
        if not filepath:
            return
        ...
        if len(def_info.columns) != 2:
            ...
            if len(def_info.columns) != 2:
                QMessageBox.about(
                    self, "Error box", "Input file doesn't have the required format."
                )
        ###
        ...
        for j in list_series_index:
            ...
            for kmd_exp in data_filtered["Kendrick mass defect"]:
                if kmd_exp >= kmd_defo - tol and kmd_exp <= kmd_defo + tol:
                    ...
                    data_filtered.at[l, "id"] = (
                        j + 1
                    )  # increment id columns to register that this specie was found when looking for the jth KMD
                    if j not in matching_series:
                        matching_series.append(
                            j
                        )  # add the serie's index to a list in case of a match
                l = l + 1
        ###
        ...
        mplcursors.cursor(
            multiple=True
        )  # .connect("add", lambda sel: sel.annotation.set_text(target))
        mngr = plt.get_current_fig_manager()
        ...
        deform_results = pandas.DataFrame(
            columns=["Group", "m/z ratio", "Rel. intensity (%)"]
        )
        for i in range(n_series):
            cmpd_id = list_cmpd[i]
            cmpd_mz = (data_filtered["m/z"][data_filtered["id"] == i + 1]).to_list()
            cmpd_int = (
                data_filtered["normalized_intensity"][data_filtered["id"] == i + 1]
            ).sum()
    ...
    def save_deformulation(self):
        ...
        if save == QMessageBox.Yes:
            ...
            if save_name != "" and save_path != "":
                self.write_csv_df(
                    save_path, save_name + ".csv", self.deformulation_results
                )
            else:
                QMessageBox.about(
                    self,
                    "Error box",
                    "Either the save path or the  file name is missing.",
                )
                return
        else:
            return
    ...
    def save_kendrick_series(self):
        ...
        if save_name != "" and save_path != "":
            ...
            QMessageBox.about(
                self, "Error box", "Either the save path or the  file name is missing."
            )
            return
    ...
    def plot_ACOS(self, gif):
        ...
        for item in item_classes:
            ...
            if (
                widgets.radioButton_norm_c.isChecked()
                or widgets.radioButton_norm_d.isChecked()
            ):
            ...
            def Anim(frames):
                ...
                plot_fun(
                    ...
                    x=frames["C"],
                    y=frames["OSc"],
                    d_color=frames["Normalized_intensity"],
                    size=self.d_size * frames["point_size"],
                    dot_type=self.dot_type,
                    edge=self.edge,
                    cmap=self.color_map,
                )
                ...
                plt.suptitle(
                    "Average carbon oxidation state vs #C",
                    fontsize=font_size + 4,
                    y=0.97,
                    x=0.45,
                )
                ...
                if gif == False:
                    mngr = plt.get_current_fig_manager()
                    mngr.window.setGeometry(
                        self.pos().x() + 940, self.pos().y() + 200, 1000, 437
                    )
                if "m/z" in frames:
                    mplcursors.cursor(multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            ...
                            + str(frames["C"].iloc[sel.target.index])
                            + ", OCs = "
                            + str(round(frames["OSc"].iloc[sel.target.index], 2))
                        ),
                    )
        ...
        for item in item_classes:
            ...
            if widgets.MAI_box.isChecked():
                data_extract["AI"] = (
                    ...
                    - 0.5 * data_extract["O"]
                    - data_extract["S"]
                    - 0.5 * (data_extract["N"] + data_extract["P"] + data_extract["H"])
                ) / (
                    data_extract["C"]
                    - 0.5 * data_extract["O"]
                    - data_extract["S"]
            ...
            cond_1 = pandas.Series(data_extract["AI"] <= 0.5) * pandas.Series(
                data_extract["AI"] >= 0
            )
            cond_2 = pandas.Series(data_extract["AI"] <= 0.67) * pandas.Series(
                data_extract["AI"] > 0.5
            )
            cond_3 = pandas.Series(data_extract["AI"] <= 1) * pandas.Series(
                data_extract["AI"] > 0.67
            )
            ...
            def Anim(frames):
                ...
                ax1 = plt.scatter(
                    ...
                    d1["H/C"],
                    c="#06a96a",
                    s=self.d_size * d1["Normalized_intensity"],
                    linewidths=0.7,
                    edgecolors="black",
                    alpha=0.7,
                )
                ax2 = plt.scatter(
                    ...
                    d2["H/C"],
                    c="#f39c1b",
                    s=self.d_size * d2["Normalized_intensity"],
                    linewidths=0.7,
                    edgecolors="black",
                    alpha=0.7,
                )
                ax3 = plt.scatter(
                    ...
                    d3["H/C"],
                    c="#de281b",
                    s=self.d_size * d3["Normalized_intensity"],
                    linewidths=0.7,
                    edgecolors="black",
                    alpha=0.7,
                )
                ...
                plt.suptitle(
                    "Van Krevelen diagram", fontsize=font_size + 4, y=0.97, x=0.45
                )

                cmap = matplotlib.colors.ListedColormap(
                    ["#06a96a", "#f39c1b", "#de281b"]
                )
                bounds = [0, 0.5, 0.67, 1]
                ...
                if "m/z" in frames:
                    mplcursors.cursor(ax1, multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            d1["molecular_formula"].iloc[sel.target.index]
                            + ", O/C = "
                            + str(d1["O/C"].iloc[sel.target.index].round(3))
                            + ", (M)AI = "
                            + str(d1["AI"].iloc[sel.target.index].round(3))
                        ),
                    )
                    mplcursors.cursor(ax2, multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            d2["molecular_formula"].iloc[sel.target.index]
                            + ", O/C = "
                            + str(d2["O/C"].iloc[sel.target.index].round(3))
                            + ", (M)AI = "
                            + str(d2["AI"].iloc[sel.target.index].round(3))
                        ),
                    )
                    mplcursors.cursor(ax3, multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            d3["molecular_formula"].iloc[sel.target.index]
                            + ", O/C = "
                            + str(d3["O/C"].iloc[sel.target.index].round(3))
                            + ", (M)AI = "
                            + str(d3["AI"].iloc[sel.target.index].round(3))
                        ),
                    )
    ...
    def plot_MCR(self, gif):
        ...
        for item in item_classes:
            ...
            cond_1 = pandas.Series(data_extract["MCR"] <= 0.2) * pandas.Series(
                data_extract["MCR"] >= 0
            )
            cond_2 = pandas.Series(data_extract["MCR"] <= 0.5) * pandas.Series(
                data_extract["MCR"] > 0.2
            )
            cond_3 = pandas.Series(data_extract["MCR"] <= 0.9) * pandas.Series(
                data_extract["MCR"] > 0.5
            )
            cond_4 = pandas.Series(data_extract["MCR"] <= 1) * pandas.Series(
                data_extract["MCR"] > 0.9
            )
            ...
            def Anim(frames):
                ...
                ax4 = plt.scatter(
                    ...
                    d4["H/C"],
                    c="#0f5fa8",
                    s=self.d_size * d4["Normalized_intensity"],
                    linewidths=0.7,
                    edgecolors="black",
                    alpha=0.7,
                )
                ...
                if "m/z" in frames:
                    mplcursors.cursor(ax1, multiple=True).connect(
                        ...
                        lambda sel: sel.annotation.set_text(
                            ...
                            + str(d1["O/C"].iloc[sel.target.index].round(3))
                            + ", MCR = "
                            + str(d1["MCR"].iloc[sel.target.index].round(3))
                        ),
                    )
                    mplcursors.cursor(ax2, multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            ...
                            + str(d2["O/C"].iloc[sel.target.index].round(3))
                            + ", MCR = "
                            + str(d2["MCR"].iloc[sel.target.index].round(3))
                        ),
                    )
                    mplcursors.cursor(ax3, multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            ...
                            + str(d3["O/C"].iloc[sel.target.index].round(3))
                            + ", MCR = "
                            + str(d3["MCR"].iloc[sel.target.index].round(3))
                        ),
                    )
                    mplcursors.cursor(ax4, multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            d4["molecular_formula"].iloc[sel.target.index]
                            + ", O/C = "
                            + str(d4["O/C"].iloc[sel.target.index].round(3))
                            + ", MCR = "
                            + str(d4["MCR"].iloc[sel.target.index].round(3))
                        ),
                    )
    ...
    def venn(self):
        ...
        if n_ech < 2 or n_ech > 6:
            QMessageBox.about(
                self, "FYI box", "Number of samples to compare must be between 2 and 6"
            )
            return
        for i in range(n_ech):
            df[i] = inde
        df = df.set_index(df[0])
        data_venn = data_venn.iloc[
            :, n_heteroatoms + 1 : n_heteroatoms + 1 + n_ech
        ]  # extracts intensity values
        ...
        index_values = pandas.DataFrame(
            {"a": data_venn.index.values}, index=data_venn.index.values
        )
        ...
        data_venn = data_venn.where(
            data_venn.eq(0), index_df.values
        )  # Replaces non-null values by their corresponding index
        dict_venn = {}
        ...
        venn_diag(
            dict_venn, fmt=disp, cmap=color_map
        ).figure.show()  # Plots using Venn.py (fonction venn_diag)
        sets = venn_sets(
            dict_venn
        )  # EXctractiong and storage of data using Venn.py (fonction venn_sets)
    ...
    def plot_composition_compare(self):
        ...
        if widgets.radio_classes_compare.isChecked():
            if widgets.edit_min_intensity_classes_compare.text():
                min_intens_classes = float(
                    widgets.edit_min_intensity_classes_compare.text()
                )
                classes = self.compared_datas.classes[
                    ~self.compared_datas.classes["variable"].str.contains("x")
                ]
            ...
            if widgets.edit_min_intensity_classes_compare.text():
                ...
                ch = self.compared_datas.classes[
                    self.compared_datas.classes["variable"].str.contains("CH")
                ]
        ...
        if widgets.radio_classes_grouped.isChecked():
            ...
            data_comp = pandas.DataFrame(
                columns=range(len(leg)), index=self.name.values()
            )
            ...
            for y in range(y_max):
                ab = np.array(data_comp.columns) - gap * (
                    0.5 - ((y + 1) / (y_max + 1))
                ) / (y_max + 1)
                plt.bar(
                    ab,
                    data_comp.iloc[y, :],
                    width=(0.14 * wid) / (y_max + 1),
                    color=color_list[y % 9],
                )
            plt.gca().legend(leg, fontsize=font_size - 4)
        ...
        for classe_selected in item_classes:
            ...
            def Anim(frames):
                ...
                if x_axes == 0:  # DBE
                    ...
                    dbe_both_m.index = list(
                        data_DBE_m.columns[1:]
                    )  # Remplace l'index par le nom de l'échantillon
                ...
                if (
                    widgets.radio_dist_nb_comp.isChecked()
                ):  # Normalize number of attribution
                    to_plt = to_plt.div(to_plt.sum(axis=1), axis=0) * 100

                for y in range(y_max):  # y_max = number of samples
                    ab = np.array(to_plt.columns) - gap * (
                        0.5 - ((y + 1) / (y_max + 1))
                    ) / (y_max + 1)
                    plt.bar(
                        ab,
                ...
                plt.xlabel(x_label, fontsize=font_size + 2)
                plt.suptitle(
                    f"{y_legend} vs {x_label}", fontsize=font_size + 4, y=0.98, x=0.45
                )
                plt.text(
                    0.88,
                    0.9,
                ...
                def on_add(sel):
                    x, y, width, height = sel.artist[sel.target.index].get_bbox().bounds
                    sel.annotation.set(
                        text=f"{y_legend}: {round(height,4)}%",
                        position=(0, 20),
                        anncoords="offset points",
                    )
                    sel.annotation.xy = (x + width / 2, y + height)
    ...
    def plot_spectrum_compare(self):
        ...
        for i in range(len(item_classes)):
            ...
            data_filtered = data_filtered.sort_values(
                by=["summed_intensity"], ascending=True
            )
            c = color_list[(i + 1) % 10 - 1]
            patch = mpatches.Patch(color=c, label=item_classes[i].text())
            leg.append(patch)
            plt.stem(
                data_filtered["m/z"],
                data_filtered["summed_intensity"],
                linefmt=c,
                markerfmt=" ",
                basefmt="k",
            )
    ...
    def compare_calculation(self):
        ...
        widgets.plot_compare.setEnabled(False)
        widgets.plot_compare_GIF.setEnabled(False)
        widgets.status_compare.setStyleSheet(
            "background-color: rgb(255, 150, 0); border-radius: 12px; color: white"
        )
        ...
        if not compare_items or len(compare_items) < 2:
            widgets.status_compare.setStyleSheet(
                "background-color: rgb(220, 0, 3); border-radius: 12px; color: white"
            )
        ...
        widgets.status_compare.setStyleSheet(
            "background-color: rgb(50, 150, 0); border-radius: 12px; color: white"
        )
    ...
    def split_classes_compare(self):
        ...
        while n < len(self.compared_datas.classes):
            item_classes = QtWidgets.QListWidgetItem(
                self.compared_datas.classes_concat.iloc[n, 0]
            )
            item_classes.setData(
                self.USERDATA_ROLE, self.compared_datas.classes.iloc[n, 0]
            )
            widgets.list_classes_mass_spec_comp.addItem(item_classes)
            item_classes = QtWidgets.QListWidgetItem(
                self.compared_datas.classes_concat.iloc[n, 0]
        ...
        widgets.list_sample_1_stats.clear()
        widgets.list_sample_2_stats.clear()
        name_data = self.compared_datas.df.iloc[
            :,
            self.compared_datas.df.columns.get_loc("count")
            + max(self.compared_datas.df["count"])
            + 1 : self.compared_datas.df.columns.get_loc("count")
            + max(self.compared_datas.df["count"]) * 2
            + 1,
        ]
        name_data.columns = name_data.columns.str.replace(".csv", "")
        name_data.columns = name_data.columns.str.replace(".xlsx", "")
    ...
    def plot_molecular_carto_DBE(self, gif=False):
        ...
        for item in item_classes:
            data_extract = self.compared_datas.df.drop(
                index=self.compared_datas.df.index[inf_index], axis=0
            ).copy()
            ...
            data_extract = data_extract.sort_values(by=["fc"], ascending=False)
            Intens = data_extract.iloc[
                :, self.compared_datas.df.columns.get_loc("summed_intensity") - 2
            ].values.reshape(-1, 1)
            min_max_scaler = preprocessing.MinMaxScaler()
            Intens_scaled = min_max_scaler.fit_transform(Intens)
            data_extract.iloc[
            ...
            if classe_selected == "All":
                ...
                classes_index = self.compared_datas.classes[
                    self.compared_datas.classes["variable"] == classe_selected
                ]
                if "x" in classe_selected:
                    index_classes = self.compared_datas.df[classe_selected] == True
                else:
                    index_classes = (
                        self.compared_datas.df[self.compared_datas.heteroatoms.columns]
                        == self.compared_datas.heteroatoms.iloc[classes_index.index[0]]
                    ).all(1)
            ...
            if widgets.radio_even_DBE_compare_2.isChecked():
                ...
                data_inf_neg = data_inf_neg.loc[
                    np.where(data_inf_neg["DBE"].apply(lambda x: x.is_integer()), 0, 1)
                    == 1
                ]
                data_inf_pos = data_inf_pos.loc[
                    np.where(data_inf_pos["DBE"].apply(lambda x: x.is_integer()), 0, 1)
                    == 1
                ]
                dbe_text = "Even ions"
            ...
            if Intens != []:
                ...
                Intens_scaled = Intens
            data_extract["Normalized_intensity"] = Intens_scaled
            data_extract = data_extract.sort_values(
                by=["fc", "Normalized_intensity"], ascending=[False, True]
            )
            ...
            def Anim(frames):
                ...
                if widgets.CheckBox_size_fc.isChecked():
                    size = self.d_size * frames.data_extract.iloc[
                        :,
                        self.compared_datas.df.columns.get_loc("summed_intensity")
                        - (n_sample)
                        + sample_1,
                    ].astype(float)
                    size_inf_neg = self.d_size * frames.data_inf_neg.iloc[
                ...
                if widgets.fc_all_dbe.isChecked():
                    plot_fun(
                        "scatter",
                        x=frames.data_inf_neg["C"],
                        y=frames.data_inf_neg["DBE"],
                        d_color="#a84ca4",
                        dot_type=self.dot_type,
                        edge=self.edge,
                        size=size_inf_neg,
                    ...
                    plot_fun(
                        "scatter",
                        x=frames.data_inf_pos["C"],
                        y=frames.data_inf_pos["DBE"],
                        d_color="#0070c0",
                        dot_type=self.dot_type,
                        edge=self.edge,
                        size=size_inf_pos,
                ...
                # plot_fun("scatter",x=frames.data_extract["C"],y=frames.data_extract["DBE"],d_color=frames.data_extract["fc"],dot_type=self.dot_type,edge=self.edge,cmap="RdYlGn",size = size)
                plt.scatter(
                    frames.data_extract["C"],
                    frames.data_extract["DBE"],
                    s=size,
                    c=frames.data_extract["fc"],
                    vmin=-8,
                    vmax=8,
                ...
                if widgets.fc_all_dbe.isChecked():
                    legend_elements = [
                        Patch(
                            facecolor="#a84ca4",
                            edgecolor="k",
                            label=leg_1 + " exclusive",
                        ),
                        Patch(
                            facecolor="#0070c0",
                            edgecolor="k",
                            label=leg_2 + " exclusive",
                        ),
                    ]
                    plt.legend(handles=legend_elements, fontsize=font_size - 4)
                if gif == False:
                ...
                if "m/z" in frames.data_extract:
                    mplcursors.cursor(multiple=True).connect(
                        "add",
                        lambda sel: sel.annotation.set_text(
                            frames.data_extract["molecular_formula"].iloc[
                                sel.target.index
                            ]
                            + ", #C = "
                            + str(frames.data_extract["C"].iloc[sel.target.index])
                            + ", DBE = "
                            + str(frames.data_extract["DBE"].iloc[sel.target.index])
                        ),
                    )
    ...
    def plot_molecular_carto_VK(self, gif=False):
        ...
        if widgets.radio_fold_rel.isChecked():
            fold_intens_1 = self.compared_datas.df.iloc[
                :,
                self.compared_datas.df.columns.get_loc("count")
                + max(self.compared_datas.df["count"])
                + 1
            ...
            fold_intens_2 = self.compared_datas.df.iloc[
                :,
                self.compared_datas.df.columns.get_loc("count")
                + max(self.compared_datas.df["count"])
                + 1
            ...
            fold_intens_1 = self.compared_datas.df.iloc[
                :, self.compared_datas.df.columns.get_loc("count") + 1 + sample_1
            ].astype(float)
            fold_intens_2 = self.compared_datas.df.iloc[
                :, self.compared_datas.df.columns.get_loc("count") + 1 + sample_2
            ].astype(float)
            leg_1 = str(fold_intens_1.name)
            leg_2 = str(fold_intens_2.name)
            leg_1 = leg_1.replace(".csv", "")
        ...
        for item in item_classes:
            ...
            x_axes, x_axes_p, x_axes_n, y_axes, y_axes_p, y_axes_n, x_label, y_label = (
                Select_Axes_VK_mol(x_axes, y_axes, data_extract, data_inf_p, data_inf_n)
            )
            ...
            def Anim(frames, x_label, y_label):
                ...
                if widgets.CheckBox_size_fc_vk.isChecked():
                    ...
                    size_inf_neg = self.d_size * frames.data_inf_n.iloc[
                        :,
                        self.compared_datas.df.columns.get_loc("summed_intensity")
                        - (n_sample)
                        + sample_1,
                    ].astype(float)
                    size_inf_pos = self.d_size * frames.data_inf_p.iloc[
                        :,
                        self.compared_datas.df.columns.get_loc("summed_intensity")
                        - (n_sample)
                        + sample_2,
                ...
                plot_fun(
                    ...
                    x=frames.x_axes,
                    y=frames.y_axes,
                    d_color=frames.data_extract["Normalized_intensity"],
                    dot_type=self.dot_type,
                    edge=self.edge,
                    cmap="RdYlGn",
                    size=size,
                ...
                if len(data.data_extract) != 0:
                    cbar = plt.colorbar(
                        ticks=[
                            min(frames.data_extract["Normalized_intensity"]),
                            max(frames.data_extract["Normalized_intensity"]),
                        ]
                    )
                    cbar.ax.set_yticklabels(
                        [leg_1, leg_2],
                ...
                if widgets.fc_all_vk.isChecked():
                    legend_elements = [
                        ...
                        Patch(
                            facecolor="blue", edgecolor="k", label=leg_2 + " exclusive"
                        ),
                    ]
                    plt.legend(handles=legend_elements, fontsize=font_size - 4)
                mngr = plt.get_current_fig_manager()
                mngr.window.setGeometry(
                    self.pos().x() + 640, self.pos().y() + 200, 800, 680
                )
                mplcursors.cursor(multiple=True).connect(
                    "add",
                    lambda sel: sel.annotation.set_text(
                        frames.data_extract["molecular_formula"].iloc[sel.target.index]
                        + ", "
                        + str(x_label)
                        + " : "
    ...
    def plot_molecular_carto_KMD(self, gif=False):
        ...
        if widgets.edit_mass_motif_compare.text():
            ...
            nominal_unit = round(repetive_unit_mass)
        self.compared_datas.df["Kendrick mass"] = self.compared_datas.df["m/z"] * (
            nominal_unit / repetive_unit_mass
        )
        self.compared_datas.df["Kendrick nominal mass"] = round(
            self.compared_datas.df["m/z"]
        )

        if widgets.round_up_compare.isChecked():
            self.compared_datas.df["Kendrick nominal mass"] = self.compared_datas.df[
                "Kendrick mass"
            ].apply(np.ceil)
        elif widgets.round_closest_compare.isChecked():
            self.compared_datas.df["Kendrick nominal mass"] = round(
                self.compared_datas.df["Kendrick mass"]
            )
        self.compared_datas.df["Kendrick mass defect"] = (
            self.compared_datas.df["Kendrick nominal mass"]
            - self.compared_datas.df["Kendrick mass"]
        )
        ...
        for item in item_classes:
            ...
            def Anim(frames):
                ...
                if widgets.fc_all_md.isChecked():
                    plot_fun(
                        "scatter",
                        x=frames.data_inf_neg["nominal_mass"],
                        y=frames.data_inf_neg["mass_defect"],
                        d_color="#a84ca4",
                        dot_type=self.dot_type,
                        edge=self.edge,
                        size=size_inf_neg,
                    ...
                    plot_fun(
                        "scatter",
                        x=frames.data_inf_pos["nominal_mass"],
                        y=frames.data_inf_pos["mass_defect"],
                        d_color="#0070c0",
                        dot_type=self.dot_type,
                        edge=self.edge,
                        size=size_inf_pos,
                ...
                # plot_fun("scatter",x=frames.data_extract["C"],y=frames.data_extract["DBE"],d_color=frames.data_extract["fc"],dot_type=self.dot_type,edge=self.edge,cmap="RdYlGn",size = size)
                plt.scatter(
                    frames.data_extract["nominal_mass"],
                    frames.data_extract["mass_defect"],
                    s=size,
                    c=frames.data_extract["fc"],
                    vmin=-8,
                    vmax=8,
    ...
    def plot_DBE_compare(self, gif=False):
        ...
        sample_list = data_selected.iloc[
            :,
            data_selected.columns.get_loc("count")
            + item_count
            + 1 : data_selected.columns.get_loc("count")
            + item_count * 2
            + 1,
        ].columns
        for item in sample_list:
            ...
            data_extract.rename(
                columns={item: "Normalized_intensity"}, inplace=True
            )  # item_name.csv => Normalized intensity

            Intens = (
                data_extract["Normalized_intensity"].values.astype(float).reshape(-1, 1)
            )  # astype(float) or crash!
    ...
    def plot_VK_compare(self, gif=False):
        ...
        for item in sample_list:
            ...
            if x_axes == 2 or y_axes == 3:
                try:
                    ...
                    QMessageBox.about(
                        self,
                        "Error",
                        "No sulfur in the selected data, (H/C)=f[(H/C)] will be plotted instead to avoid crash.",
                    )
            ...
            if x_axes == 0 or y_axes == 1:
                try:
                    ...
                    QMessageBox.about(
                        self,
                        "Error",
                        "No oxygen in the selected data, (H/C)=f[(H/C)] will be plotted instead to avoid crash.",
                    )
            ...
            if x_axes == 1 or y_axes == 2:
                try:
                    ...
                    QMessageBox.about(
                        self,
                        "Error",
                        "No nitrogen in the selected data, (H/C)=f[(H/C)] will be plotted instead to avoid crash.",
                    )
            ...
            def Anim(frames):
                ...
                if (
                    widgets.checkBox_vk_area_comp.isChecked()
                    and widgets.list_VK_x_comp.currentRow() == 0
                    and widgets.list_VK_y_comp.currentRow() == 0
                ):
                    border_width = 4
                    alpha = 1
                    patches = [
    ...
    def plot_KMD_compare(self, gif=False):
        ...
        for item in sample_list:
            ...
            def Anim(frames):
                ...
                if (
                    widgets.stackedWidget_Kendrick_comp.currentIndex() == 0
                ):  # KMD classic
                ...
                try:
                    ...
                    QMessageBox.about(
                        self, "Error", "This heteroatom is not in datasets"
                    )
                    pass
