...
def merge_merged_file(names, isotopes_dict):
    ...
    if len(names[0]) == 1:
        ...
        if m != 0:
            ...
            while n < len(names[0]):
                filter_col_abs = [
                    col for col in temp_data["%s" % n] if "Abs_intens" in col
                ]
                filter_col_abs.append("molecular_formula")
                filter_col_rel = [
                    col for col in temp_data["%s" % n] if "Rel_intens" in col
                ]
            ...
            while n < len(names[0]):
                data_frames_abs_intens.append(
                    temp_data["%s" % n][["molecular_formula", "absolute_intensity"]]
                )
                data_frames_rel_intens.append(
                    temp_data["%s" % n][["molecular_formula", "normalized_intensity"]]
                )
                n = n + 1
            n_samples = n
        ###############################################################################
